/* global React */
const {Fragment, createElement, useCallback, useContext, useEffect, useState} = React
...
function Item({className, name, juristic, position, city, start, end, description}) {
  return createElement(
    'section',
    {
      className: classNames('working-experience-item', className),
    },
    createElement('header', {}, createElement('span', {}, name), ' ', createElement('em', {}, juristic)),
    createElement(
      'div',
      {},
      createElement('div', {}, createElement('strong', {}, position)),
      createElement(
        'div',
        {},
...
function List({workingExperience}) {
  ...
  return createElement(
    ...
    descSortedWorkingExperience.map(item => {
      const {name, juristic, position, city, start, end, description} = item
...
function WorkingExperience({workingExperience}) {
